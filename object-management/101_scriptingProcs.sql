...
1. Use this script to create a procedure that will generate the create script for a particular procedure
2. Usage: SQL Server 2005 onwards
*/
if object_id('dbo.RetornaTextoProc') is not null
	drop PROCEDURE dbo.RetornaTextoProc
GO
create procedure dbo.RetornaTextoProc
