...
drop table #t2
IF OBJECT_ID('tempdb..#tempdep') IS NOT null
drop table #tempdep
...
WHERE
(tt.name=@_msparam_0 and SCHEMA_NAME(tt.schema_id)=@_msparam_1)',N'@_msparam_0 nvarchar(4000),@_msparam_1 nvarchar(4000)',@_msparam_0=N'TipoTabelaSkuLojistaVirtual',@_msparam_1=N'dbo'
