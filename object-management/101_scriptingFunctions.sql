...
1. Use this script to create a procedure that will generate the create script for a particular function
2. Usage: SQL Server 2005 onwards
*/

if object_id('dbo.RetornaTextoFunc') is not null
	drop PROCEDURE dbo.RetornaTextoFunc
GO
create procedure dbo.RetornaTextoFunc
